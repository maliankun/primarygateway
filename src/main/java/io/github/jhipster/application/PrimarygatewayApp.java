...
@EnableZuulProxy
public class PrimarygatewayApp {

    private static final Logger log = LoggerFactory.getLogger(PrimarygatewayApp.class);

    private final Environment env;

    public PrimarygatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes primarygateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PrimarygatewayApp.class);
